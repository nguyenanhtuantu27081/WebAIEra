...
export const detailTranslations = {
  vi: {
    ...
    'land-h2-case': 'Dự án tiêu biểu',
    'land-case-desc': 'AI Era thiết kế landing page và triển khai hosting cho <a href="https://arabeautycenter.com/" target="_blank" rel="noopener" style="color:var(--indigo-2);">ARA Beauty Center</a>, tối ưu tốc độ tải, form thu lead và trải nghiệm chuyển đổi cho landing page ngành spa & thẩm mỹ.',
  ...
  en: {
    ...
    'land-h2-case': 'Featured Projects',
    'land-case-desc': 'AI Era designed and hosted a high-converting landing page for <a href="https://arabeautycenter.com/" target="_blank" rel="noopener" style="color:var(--indigo-2);">ARA Beauty Center</a>, optimizing load speeds, lead capture forms, and mobile conversion experience for the aesthetics & spa sector.',
    ...
    'seo-case-desc': 'AI Era designed and deployed an SEO-standard website for <a href="https://arabeautycenter.com/" target="_blank" rel="noopener" style="color:var(--indigo-2);">ARA Beauty Center</a>, optimizing information architecture, load speed, and SEO-compliant heading/schema structures tailored for the beauty, spa & aesthetics industry.',
