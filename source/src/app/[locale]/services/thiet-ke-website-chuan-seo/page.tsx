      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(serviceSchema({
            ...
            url: `${siteConfig.url}/${locale}/services/thiet-ke-website-chuan-seo`,
          })),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(breadcrumbSchema([
            ...
            { name: 'Thiết kế website chuẩn SEO', url: `${siteConfig.url}/${locale}/services/thiet-ke-website-chuan-seo` },
          ])),
        }}
      />
    </div>
